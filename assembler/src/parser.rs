...
mod tests {
    ...
    #[test]
    fn parse_assembly() {
        let input = testutils::read_test_file("parsing/assembly");
    ...
    #[test]
    fn parse_label() {
        let input = testutils::read_test_file("parsing/label");
    ...
    fn parse_with_no_newline_at_the_last_line() {
        let input = testutils::read_test_file("parsing/no_newline");
